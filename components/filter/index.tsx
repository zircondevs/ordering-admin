	...
	return (
		<Container2 height="auto" width="auto" alignItems="flex-start" >
			...
			<Flex justifyContent="flex-start" height="auto" >
				<Small fontFamily='quicksand' weight="600" lineHeight="19" size="14" colour={"Black.default"}>Filter </Small>
			...
			</Flex>
			{
				date ? 
					<Flex width="auto" height="auto" wrap="nowrap" className="clearFilter" as="button" type="button" onClick={() => setDate("")}>
						...
						<Small fontFamily='quicksand' weight="400" lineHeight="19" size="12" colour={"Error.default"}>Clear Filter </Small>
					</Flex>
					: null
			}
