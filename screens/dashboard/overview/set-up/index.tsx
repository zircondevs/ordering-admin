	...
	return (
		<Flex justifyContent="space-between">
			<Flex width="auto" wrap="nowrap">
				...
				<div>
					<Span fontFamily='quicksand' weight="400" lineHeight="19" size="14" colour={ "Grey.2"}>
						Finish Up Set Up  {" "}
						<Bold fontFamily='quicksand' weight="700" lineHeight="19" size="14" colour={ "Grey.2"}>
				...
				progress.map((item) => (
					<AccordionBodyStyles key={item.title} justifyContent="space-between">
						<Flex width="auto">
							...
							<Span fontFamily='quicksand' weight="400" lineHeight="19" size="14" colour={ "Grey.3"}>
								{item.title}
							</Span>
						</Flex>
						...
						<Flex width="max-content" height="auto" className="links" justifyContent="flex-start">
							<div>
								<Link href={item.link}>
									<Bold fontFamily='quicksand' weight="700" lineHeight="19" size="14" colour={ "Orange.default"}>
										{item.linkText}
									</Bold>
								</Link>
							</div>
